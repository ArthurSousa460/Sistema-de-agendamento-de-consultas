...
public class PacienteDAO {
    ...
    public Boolean criarPaciente(String nome, String dataNascimento){
        Date dateSql = Date.valueOf(dataNascimento);
        PacienteModel newPaciente = new PacienteModel(nome, dateSql);

        String sql =  "INSERT INTO paciente(nome, data_nascimento) VALUES(?, ?)";
        try{
            PreparedStatement preparedStatement = conn.prepareStatement(sql);
            preparedStatement.setString(1, newPaciente.getNome());
            preparedStatement.setDate(2, newPaciente.getDataNascimento());
    ...
    public List<PacienteModel> getAllPacientes(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                Date dataNacimento = rs.getDate("data_nascimento");
